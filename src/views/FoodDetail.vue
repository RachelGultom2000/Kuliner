...
export default {
  ...
  methods: {
    ...
    pemesanan() {
      if (this.pesan.jumlah_pemesanan) {
        ...
        axios
          .post("https://my-json-server.typicode.com/RachelGultom2000/BackendKuliner/keranjangs", this.pesan)
          .then(() => {
  ...
  mounted() {
    axios
      .get("https://my-json-server.typicode.com/RachelGultom2000/BackendKuliner/products/" + this.$route.params.id)
